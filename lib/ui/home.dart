...
import 'package:devkitflutter/ui/order_history.dart';
import 'package:devkitflutter/ui/reusable/reusable_widget.dart';
import 'package:devkitflutter/model/banner_slider_model.dart';
import 'package:devkitflutter/model/category_model.dart';
import 'package:devkitflutter/model/food_model.dart';
import 'package:devkitflutter/model/restaurant_model.dart';
import 'package:devkitflutter/ui/category_menu.dart';
import 'package:devkitflutter/ui/coupon.dart';
import 'package:devkitflutter/ui/favorites_food_list.dart';
import 'package:devkitflutter/ui/search_restaurant.dart';
...
import 'package:devkitflutter/ui/food_list.dart';
import 'package:devkitflutter/ui/restaurant_list.dart';
import 'package:devkitflutter/ui/user_profile.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  void _getData(){
    ...
    height = 320px
     */
    _bannerData.add(BannerSliderModel(id: 1, image: '$globalUrl/apps/food_delivery/home_banner/1.jpg'));
    _bannerData.add(BannerSliderModel(id: 2, image: '$globalUrl/apps/food_delivery/home_banner/2.jpg'));
    _bannerData.add(BannerSliderModel(id: 3, image: '$globalUrl/apps/food_delivery/home_banner/3.jpg'));
    _bannerData.add(BannerSliderModel(id: 4, image: '$globalUrl/apps/food_delivery/home_banner/4.jpg'));
    ...
    height = 110px
     */
    _categoryData.add(CategoryModel(id: 1, name: 'Nearby', image: '$globalUrl/apps/food_delivery/category/nearby.png'));
    _categoryData.add(CategoryModel(id: 2, name: 'Western Food', image: '$globalUrl/apps/food_delivery/category/western.png'));
    _categoryData.add(CategoryModel(id: 3, name: 'Eastern Food', image: '$globalUrl/apps/food_delivery/category/eastern.png'));
    _categoryData.add(CategoryModel(id: 4, name: 'Healthy Food', image: '$globalUrl/apps/food_delivery/category/health.png'));
    _categoryData.add(CategoryModel(id: 5, name: 'Coffee', image: '$globalUrl/apps/food_delivery/category/coffee.png'));
    _categoryData.add(CategoryModel(id: 6, name: 'New Comers', image: '$globalUrl/apps/food_delivery/category/new.png'));
    _categoryData.add(CategoryModel(id: 7, name: 'Best Sellers', image: '$globalUrl/apps/food_delivery/category/best.png'));
    _categoryData.add(CategoryModel(id: 8, name: 'All Foods', image: '$globalUrl/apps/food_delivery/category/all.png'));
            ...
            children: [
              ...
              GestureDetector(
                ...
                child: Row(
                  children: [
                    Flexible(
                      child: Text(_address, style: const TextStyle(
                          fontSize: 15,
                          color: Colors.black
          ...
          bottom: PreferredSize(
            ...
            child: Container(
              ...
              child: TextButton(
                  ...
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) => const SearchRestaurantPage()));
                  },
                  child: Row(
                    children: [
          ...
          actions: [
            Padding(
                ...
                child: GestureDetector(
                  onTap: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) => const FavoritesFoodListPage()));
                  },
  ...
  Widget _buildHomeBanner(){
    return Column(
      children: [
        ...
        CarouselSlider(
          items: _bannerData.map((item) => ClipRRect(
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              ...
              GestureDetector(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const RestaurantListPage(title: 'Food Arround You')));
                },
                child: const Text('View All', style: GlobalStyle.viewAll, textAlign: TextAlign.end),
              )
            ],
          ),
        ),
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              ...
              GestureDetector(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const RestaurantListPage(title: 'Order Again')));
                },
                child: const Text('View All', style: GlobalStyle.viewAll, textAlign: TextAlign.end),
              )
            ],
      ...
      children: [
        Container(
          ...
          child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              const Text('Food on Promotion', style: GlobalStyle.horizontalTitle),
              GestureDetector(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context) => const FoodListPage(title: 'Food on Promotion')));
                },
                child: const Text('View All', style: GlobalStyle.viewAll, textAlign: TextAlign.end),
              )
            ],
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        data.discount!=0?const SizedBox(width: 6):const SizedBox.shrink(),
                        data.discount!=0
                            ? Text('\$ ${_globalFunction.removeDecimalZeroFormat(data.price)}', style: GlobalStyle.textPriceLineThrough) : const SizedBox.shrink()
                      ],
                    )
                  ],
                ),
  ...
  Widget _buildMoreRestaurant(){
    return Column(
      ...
      children: [
        Container(
          padding: const EdgeInsets.fromLTRB(16, 24, 16, 0),
          child: const Text('More Restaurant', style: GlobalStyle.horizontalTitle),
        ),
        Container(
