...
class _OpFeedbackPageState extends State<OpFeedbackPage> {
                ...
                children: [
                  ...
                  Expanded(
                    child: ElevatedButton.icon(
                      ...
                      label: Text(
                        _isLoadingQuestions ? context.opTranslate('loading') : context.opTranslate('next'),
                        style: const TextStyle(
                          color: Colors.white,
                          fontSize: 16,
                          fontWeight: FontWeight.w600,
  ...
  Widget buildDropdown() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('${context.opTranslate('select_department').replaceAll('Select ', '')} *',
            ...
            : LayoutBuilder(
                builder: (context, constraints) {
                  return DropdownButtonFormField<String>(
                    ...
                    decoration: inputDecoration(context.opTranslate('select_department'))
                    ...
                    validator: (value) =>
                        value == null ? context.opTranslate('department_required') : null,
                  );
                },
              ),
        const SizedBox(height: 16),
